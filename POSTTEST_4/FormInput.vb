Public Class FormInput
    ...
    Private Sub txtNama_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtNama.KeyPress
        ' Memeriksa apakah karakter yang diketik adalah BUKAN huruf, BUKAN spasi, dan BUKAN tombol kontrol (seperti Backspace)
        If Not Char.IsLetter(e.KeyChar) AndAlso Not e.KeyChar = Chr(Keys.Space) AndAlso Not Char.IsControl(e.KeyChar) Then
            ' Jika bukan ketiganya, batalkan inputan (karakter tidak akan muncul di textbox)
            e.Handled = True
